...
[![Publish Self-Contained](https://github.com/<OWNER>/<REPO>/actions/workflows/publish-self-contained.yml/badge.svg)](https://github.com/<OWNER>/<REPO>/actions/workflows/publish-self-contained.yml) [![Build MSI](https://github.com/<OWNER>/<REPO>/actions/workflows/build-msi.yml/badge.svg)](https://github.com/<OWNER>/<REPO>/actions/workflows/build-msi.yml)
...
Replace `<OWNER>/<REPO>` in the badge URLs with your GitHub repo path to enable actionable badges.
